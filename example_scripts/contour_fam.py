...
for wf in wfs:
    ...
    RUN = True
    if RUN:
        rom_builder.build_snapshot_basis(max_workers=16)
...
#     path_to_snapshot = '../_output/xy.12.12.100.100.0.0.xy'
#     path_to_snapshot = '../_output/xy.12.12.200.200.0.0.xy'
...
#
# print(m1)
# m1_file = (3.0934/3.0087)**(0) * 1.90478056E+04
#
# hbm = 20.73553 # in bskg5, hbar^2/(2m)
# e_eff = 1.0
# r2_ch = 3.0934**2
# r2_ma = 3.0087**2
# m1_formula = 4.0 * e_eff**2 * hbm * (24) * r2_ch
